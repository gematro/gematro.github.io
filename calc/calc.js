...
var gematroVersion = '26.1.4.0' // YY.M.D.revision
...
function createAboutMenu() { // create menu with all cipher catergories
	...
	o += '<div style="margin: 0.5em;"></div>'
	o += '<div style="position: relative;"><div class="discordLogo">'+discordSvgLogo()+'</div><a class="intBtnRepo" target="_blank" href="https://discord.gg/mAvMeHKArm">Discord</a></div>'
	o += '<div style="margin: 0.5em;"></div>'
